...
about_page <- tabPanel(
  title = "About",
  titlePanel("About"),
  "Created with R Shiny for the analysis of the data of online food delivery services.This project as a part for partial fulfillment of the requirements for the degree of bachelor of Technology in Computer science and Engineering of Gauhati University.",
  br(),
...
main_page <- tabPanel(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput("num_var_1", "Factor 1", choices = c(not_sel)),
      selectInput("num_var_2", "Factor 2", choices = c(not_sel)),
      selectInput("fact_var", "Factor 3", choices = c(not_sel)),
      br(),
